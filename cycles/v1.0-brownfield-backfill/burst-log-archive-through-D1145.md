---
document_type: cycle-burst-log-archive
producer: state-manager
cycle: v1.0-brownfield-backfill
version: "1.0"
---

# v1.0-brownfield-backfill Cycle Burst Log Archive (through D-1145)

Archived 2026-09-20: bursts D-1063 through D-1145 relocated from `burst-log.md` during fuel-wall
compaction. `burst-log.md` retains D-1146 onward.
